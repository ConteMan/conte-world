...
<script>
import Result from '@/components/antd/result/Result'
import DetailList from '@/components/antd/tool/DetailList'
import AStepItem from '@/components/antd/tool/AStepItem'
