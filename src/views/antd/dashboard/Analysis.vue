...
<script>
import ChartCard from '@antdcomponents/card/ChartCard'
import MiniArea from '@antdcomponents/chart/MiniArea'
import MiniBar from '@antdcomponents/chart/MiniBar'
import MiniProgress from '@antdcomponents/chart/MiniProgress'
import Bar from '@antdcomponents/chart/Bar'
import RankingList from '@antdcomponents/chart/RankingList'
import HotSearch from '@antdcomponents/analysis/HotSearch'
import SalesData from '@antdcomponents/analysis/SalesData'
import Trend from '@antdcomponents/chart/Trend'
