...
<script>
import PageHeader from '@antdcomponents/page/PageHeader'
import PageLayout from '@/layouts/antd/PageLayout'
import HeadInfo from '@antdcomponents/tool/HeadInfo'
import Radar from '@antdcomponents/chart/Radar'
